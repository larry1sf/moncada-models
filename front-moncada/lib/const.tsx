  ...
  faqs: [
    {
      ...
      answer: "¡Sí! Nuestra boutique principal está ubicada en Bucaramanga. Puedes encontrarnos en la Cra 17 #3359, Centro. Te esperamos para brindarte una asesoría personalizada."
    },
    {
    ...
    },
    {
      ...
      answer: "Aceptamos transferencias bancarias (Bancolombia, Nequi) y pagos en efectivo en nuestra boutique física."
    }
  ]
};
export const socials = [
  {
    name: "Instagram",
    url: "https://www.instagram.com/moncada_models/",
    icon: IconBrandInstagram
  },
  {
    name: "Facebook",
    url: "https://www.facebook.com/moncada_models/",
    icon: IconBrandFacebook
  },
  {
    name: "WhatsApp",
    url: "https://wa.me/573024512965",
